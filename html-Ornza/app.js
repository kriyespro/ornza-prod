...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let productsData = window.ORNZA_PRODUCTS;
  ...
  // Quick view → product detail page
  ...
  // Product card click → detail page (except buttons/links)
  document.querySelectorAll('.product-card').forEach(card => {
    const prodId = card.querySelector('[data-product-id]')?.getAttribute('data-product-id');
    if (!prodId) return;
    ...
    if (title) {
      title.classList.add('ornza-tw', 'hover:text-gold-deep', 'transition-colors');
    }
  });
